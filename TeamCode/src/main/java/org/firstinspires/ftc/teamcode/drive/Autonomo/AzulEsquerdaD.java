...
public class AzulEsquerdaD extends LinearOpMode {
    //Pixel no Direita
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startPose)
                .strafeLeft(5) //Ir na Diagonal Esquerda
                .forward(39) //Ir para Frente
                .turn(Math.toRadians(-90)) //Girar para a Direita
                .strafeLeft(7) //Ir na Diagonal Esquerda
                .build();
        ...
        TrajectorySequence traj4 = drive.trajectorySequenceBuilder(traj3.end())
                ...
                .strafeRight(40) //Ir na Diagonal Direita
                .back(20) //Estacionar
                .build();
