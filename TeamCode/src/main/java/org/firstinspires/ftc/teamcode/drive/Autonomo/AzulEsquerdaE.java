...
public class AzulEsquerdaE extends LinearOpMode {
    //Pixel no Esquerda
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startPose)
                .strafeLeft(11) //Ir na Diagonal Esquerda
                .forward(22) //Ir para Frente
                .build();
        TrajectorySequence traj2 = drive.trajectorySequenceBuilder(traj1.end())
                .turn(Math.toRadians(-90)) //Girar para a Direita
                .back(43) //Ir para trás até o Backdrop
                .strafeLeft(17) //Ir na Diagonal Esquerda
                .build();
        ...
        TrajectorySequence traj4 = drive.trajectorySequenceBuilder(traj3.end())
                ...
                .strafeRight(33) //Ir na Diagonal Direita
                .back(30) //Estacionar
                .build();
